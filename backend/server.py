...
PRODUCTS = [
    Product(
        ...
        name="Fynbos Roast",
        slug="fynbos-roast",
        description="A smooth, nutty, and balanced medium roast inspired by the unique flora of the Cape's fynbos biome. Perfect for everyday enjoyment.",
        flavor_notes="Smooth · Nutty · Balanced",
        price=149.00,
        image_url="https://images.pexels.com/photos/15093129/pexels-photo-15093129.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
        roast_level="Medium",
        weight="250g"
    ),
    Product(
        ...
        description="Journey through the lush Garden Route with this smooth blend featuring hints of cocoa and gentle citrus notes.",
        flavor_notes="Smooth · Cocoa · Gentle Citrus",
        price=149.00,
        image_url="https://images.pexels.com/photos/17303602/pexels-photo-17303602.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
        roast_level="Medium",
        weight="250g"
    ),
    Product(
        ...
        name="Ember Reserve",
        slug="ember-reserve",
        description="Our boldest offering - a dark, rich roast for those who prefer their coffee with intensity and depth.",
        flavor_notes="Bold · Rich · Dark",
        price=159.00,
        image_url="https://images.pexels.com/photos/14498531/pexels-photo-14498531.jpeg",
        roast_level="Dark",
        weight="250g"
    ),
    Product(
        ...
        name="Karoo Horizon",
        slug="karoo-horizon",
        description="A limited edition blend capturing the bright, expansive spirit of the Karoo with blueberry and floral notes.",
        flavor_notes="Bright · Blueberry · Floral",
        price=169.00,
        image_url="https://images.pexels.com/photos/12039675/pexels-photo-12039675.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    ...
    Product(
        ...
        description="Experience the complete Cape Ember journey with all four signature blends. The perfect introduction to our range.",
        flavor_notes="Complete Collection · 4 x 250g",
        price=599.00,
        image_url="https://images.pexels.com/photos/13121702/pexels-photo-13121702.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
        roast_level="Variety",
        weight="4 x 250g",
        is_bundle=True,
